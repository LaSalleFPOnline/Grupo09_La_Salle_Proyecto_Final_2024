...
<html lang="es">
    ...
    <body>
        ...
        <table>
            <thead>
                <tr>
                    <th style="text-align:right"><h1>Listado de articulos</h1></th>    
                </tr>
            </thead>
        </table>
        <table style="width:100%; border-collapse: collapse">
            <thead>
                <tr style="border: 1px solid black">
                    <th style="border: 1px solid black; text-align: center">Codigo del articulo</th>
                    <th style="border: 1px solid black; text-align: center">Articulo</th>
            ...
            <tbody>
                @foreach($articulos as $articulo)
                    <tr style="border: 1px solid black">
                        <td style="border: 1px solid black; text-align: center">{{ $articulo->CodigoArticulo }}</td>
                        <td style="border: 1px solid black; text-align: center">{{ $articulo->DescripcionArticulo }}</td>
                        <td style="border: 1px solid black; text-align: center">{{ $articulo->FamiliaId }}</td>
                        <td style="border: 1px solid black; text-align: center">{{ $articulo->Stock }}</td>
                        <td style="border: 1px solid black; text-align: center">{{ $articulo->Precio }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
