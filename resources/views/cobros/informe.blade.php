...
<html lang="es">
    ...
    <body>
        ...
        <table>
            <thead>
                <tr>
                    <th style="text-align:right"><h1>Listado de cobros</h1></th>    
                </tr>
            </thead>
        </table>
        <table style="width:100%; border-collapse: collapse">
            <thead>
                <tr style="border: 1px solid black">
                    <th style="border: 1px solid black; text-align: center">Código del cobro</th>
                    <th style="border: 1px solid black; text-align: center">Código de la venta</th>
                    <th style="border: 1px solid black; text-align: center">Importe</th>
                </tr>
            </thead>
            <tbody>
                @foreach($cobros as $cobro)
                    <tr style="border: 1px solid black">
                        <td style="border: 1px solid black; text-align: center">{{ $cobro->CobroId }}</td>
                        <td style="border: 1px solid black; text-align: center">{{ $cobro->VentaId }}</td>
                        <td style="border: 1px solid black; text-align: center">{{ number_format($cobro->Importe, 2, ',', '.') }} €</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
