<html>
    ...
    <body>
        ...
        <a class="boton-tienda-online boton-hover" target="_blank" href="{{ route('listar_pistas') }}">Tienda Online</a>
        <a class="boton-reservar-pista boton-hover" target="_blank" href="{{ route('listar_pistas') }}">Reservar pistas</a>        
    </body>
    <footer>
