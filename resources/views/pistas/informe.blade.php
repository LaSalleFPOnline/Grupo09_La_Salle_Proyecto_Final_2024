...
<html lang="es">
    ...
    <body>
        ...
        <table>
            <thead>
                <tr>
                    <th style="text-align:right"><h1>Listado de pistas</h1></th>    
                </tr>
            </thead>
        </table>
        <table style="width:100%; border-collapse: collapse">
            <thead>
                <tr style="border: 1px solid black">
                    <th style="border: 1px solid black; text-align: center">Codigo de pista</th>
            ...
            <tbody>
                @foreach($pistas as $pista)
                    <tr style="border: 1px solid black">
                        <td style="border: 1px solid black; text-align: center">{{ $pista->CodigoPista }}</td>
                        <td style="border: 1px solid black; text-align: center">{{ $pista->DescripcionPista }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
