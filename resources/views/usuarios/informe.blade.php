...
<html lang="es">
    ...
    <body>
        ...
        <table>
            <thead>
                <tr>
                    <th style="text-align:right"><h1>Listado de usuarios</h1></th>    
                </tr>
            </thead>
        </table>
        <table style="width:100%; border-collapse: collapse">
            <thead>
                <tr style="border: 1px solid black">
                    <th style="border: 1px solid black; text-align: center">Id Usuario</th>
                    ...
                    <th style="border: 1px solid black; text-align: center">Administrador</th>
                </tr>
            </thead>
            <tbody>
                @foreach($usuarios as $usuario)
                    <tr style="border: 1px solid black">
                        <td style="border: 1px solid black; text-align: center">{{ $usuario->UserId }}</td>
                        <td style="border: 1px solid black; text-align: center">{{ $usuario->Nombre }}</td>
                        <td style="border: 1px solid black; text-align: center">{{ $usuario->Email }}</td>
                        <td style="border: 1px solid black; text-align: center">{{ $usuario->Password }}</td>
                        <td style="border: 1px solid black; text-align: center">{{ $usuario->IsAdmin == 0 ? 'NO' : 'SI' }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
